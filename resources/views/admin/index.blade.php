            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="text-md font-weight-bold text-warning text-uppercase mb-1">{{ $countUser }} User</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="text-md font-weight-bold text-primary text-uppercase mb-1">{{ $allBab['totalBab'] }} Materi</div>
                    </div>
                </div>
            </div>
        </div>
